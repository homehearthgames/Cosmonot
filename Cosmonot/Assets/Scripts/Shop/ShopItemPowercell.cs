...
public class ShopItemPowercell : ShopItem{
    public bool generatorRange;
    ...
    public override void Update() {
        if(!placed ){
            ...
            placeable = !ContainsObstruction(hits) && (generatorRange || powercellRange) ? true : false;
